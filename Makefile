...
OBJECTS = GenericLevel.o Subject.o Observer.o GenericBlock.o BoardModel.o TextDisplay.o GraphicalDisplay.o Controller.o GameManager.o IBlock.o JBlock.o LBlock.o OBlock.o SBlock.o ZBlock.o TBlock.o StarBlock.o main.o#object files  // TODO: to be updated
